...
public:
	...
	// High score persistente (NVS). current_cpu viene sempre riportato a 0
	// esplicitamente all'ultima riga di run_frame (prima dell'IRQ principale),
	// quindi il default hiscoreRead/Write (rdZ80/wrZ80) e' sempre coerente,
	// nessun override necessario.
	const char *hiscoreKey() override { return "starforc"; }
