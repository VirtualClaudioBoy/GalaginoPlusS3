...
void starforce::blit_tile_fg(short row, char col) {
  ...
  const uint32_t *tile_data = starforce_fg_tilemap[final_tile_code];
...
// High score: da MAME hiscore.dat, set "starforc" (voce condivisa dal gruppo
// starforc/starforca/starforcb/starforce).
const hiscore_region_S *starforce::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0x8038, 0x70, 0x00, 0x00 },
    { 0x8348, 0x04, 0x00, 0x00 },
    { 0x9261, 0x01, 0x23, 0x23 },
    { 0x9241, 0x01, 0x23, 0x23 },
    { 0x9221, 0x01, 0x23, 0x23 },
    { 0x9201, 0x01, 0x1d, 0x1d },
    { 0x91e1, 0x01, 0x18, 0x18 },
    { 0x91c1, 0x01, 0x21, 0x21 },
    { 0x91a1, 0x01, 0x18, 0x18 },
    { 0x9181, 0x01, 0x18, 0x18 },
  };
