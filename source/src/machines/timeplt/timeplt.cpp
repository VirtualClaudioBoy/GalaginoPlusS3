...
// High score: da MAME hiscore.dat, set "timeplt" (voce condivisa dal gruppo
// timeplt/timeplta/timepltc).
const hiscore_region_S *timeplt::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0xab08, 0x28, 0x00, 0xf1 },
    { 0xa98b, 0x03, 0x00, 0x01 },
  };
