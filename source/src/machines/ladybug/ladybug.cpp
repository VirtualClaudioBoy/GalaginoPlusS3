...
// High score: da MAME hiscore.dat, set "ladybug" (voce condivisa dal gruppo
// ladybug/ladybugb/ladybugb2 — set con ROM l1.c4..l8.l7, quello usato dal
// nostro converter; NON "ladybugg", bootleg con ROM diverse).
const hiscore_region_S *ladybug::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0x6073, 0x1b, 0x01, 0x00 },
    { 0xd380, 0x75, 0xff, 0xff },
  };
