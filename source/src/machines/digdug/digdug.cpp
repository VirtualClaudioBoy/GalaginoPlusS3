...
// High score: da MAME hiscore.dat, set "digdug" (voce condivisa dal gruppo
// digdug/digdug1/digdugat/digdugat1/dzigzag).
const hiscore_region_S *digdug::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0x89a0, 0x25, 0x01, 0x01 },
  };
