...
// High score: da MAME hiscore.dat, set "galaxian" (voce condivisa da un
// ampio gruppo galaxian.cpp: asideral/astrians/devilfsh*/galaktron/galap*/
// galartic/galaxbsf*/galaxcirsa/galaxian*/galaxrcgg/galaxrf*/galaxyx/galemp/
// galkamika/galturbo/gteikoku*/mltiwars/pajaroes/redufo*/skyraidr/spacbat*/
// spacempr/superg*/swarm/uniwars*/zerotime*).
const hiscore_region_S *galaxian::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0x40a8, 0x03, 0x00, 0x00 },
  };
