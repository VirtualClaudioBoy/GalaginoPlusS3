...
public:
	...
	// High score persistente (NVS). RAM 0x4000-0x47FF e' pura (default
	// hiscoreRead/Write = rdZ80/wrZ80 vanno bene), CPU singola (audio
	// discreto sulla CPU principale, nessun sound Z80 separato).
	const char *hiscoreKey() override { return "galaxian"; }
