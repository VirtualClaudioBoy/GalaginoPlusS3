...
// from MAME hiscore.dat, entry "theglobp" (the Pac-Man conversion set this
// port uses — the "theglob" entry is the native EPOS hardware set with a
// different memory map, its 0x7Bxx addresses do NOT apply here)
const hiscore_region_S *theglob::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0x4c48, 0x3c, 0x4d, 0x00 },   // high score table
    { 0x4c93, 1,    0x01, 0x01 },
    { 0x4cb9, 1,    0x15, 0x15 },
  };
  *count = 3;
