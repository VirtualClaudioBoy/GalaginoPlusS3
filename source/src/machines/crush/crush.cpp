...
// from MAME hiscore.dat (crush)
const hiscore_region_S *crush::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0x4c80, 3,    0x00, 0x00 },   // high score (BCD)
    { 0x4e40, 0x1e, 0x4b, 0x00 },   // high score table
  };
  *count = 2;
  return regions;
}
