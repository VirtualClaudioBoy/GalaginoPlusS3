...
// High score: da MAME hiscore.dat, set "bagman" (voce condivisa da un ampio
// gruppo di cloni: bagman/bagmanf/bagmanj/bagmanm2/bagmanmc/bagmans/
// bagmans3/bagmans4/bagnard/bagnarda/bagnardi/bagnardio/sbagman/sbagman2/
// sbagmani/sbagmans).
const hiscore_region_S *bagman::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0x6217, 0x50, 0x00, 0x10 },
  };
