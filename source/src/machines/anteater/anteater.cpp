...
// High score: da MAME hiscore.dat, set "anteater" (base, non "anteaterg"/
// "anteatergg"/"anteateruk" che sono varianti con init pattern diverso).
const hiscore_region_S *anteater::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0x80ef, 0x3c, 0x01, 0x4c },
  };
