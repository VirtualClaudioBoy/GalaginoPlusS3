...
public:
	...
	// (2 CPU Z80: main+audio) che a fine frame puo' restare a 1 se
	// irq_enable[0] e' falso -> accesso diretto alla RAM principale
	// (0x8000-0x87FF), bypassando il dispatch.
	const char *hiscoreKey() override { return "frogger"; }
