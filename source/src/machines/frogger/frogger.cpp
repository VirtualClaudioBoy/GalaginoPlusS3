...
// High score: da MAME hiscore.dat, set "frogger" (voce condivisa dal gruppo
// frogger/froggeram/froggermc/froggers1/froggers2/froggers3/froggert/quaak).
const hiscore_region_S *frogger::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0x83f1, 0x0a, 0x63, 0x01 },
    { 0x83ef, 0x02, 0x63, 0x04 },
  };
...
#ifdef LED_PIN
void frogger::gameLeds(CRGB *leds) {
