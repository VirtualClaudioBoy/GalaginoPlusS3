...
// High score: da MAME hiscore.dat, set "dkong" (voce condivisa dal gruppo
// dkong/dkongf/dkonghrd/dkongj/dkongjo/dkongjo1/dkongo/dkongpe).
const hiscore_region_S *dkong::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0x6100, 0xaa, 0x94, 0x76 },
    { 0x60b8, 0x03, 0x50, 0x00 },
