...
public:
	...
	// High score persistente (NVS). Regioni proprie (diverse da dkong),
	// stessa RAM pura 0x6000-0x77FF -> default hiscoreRead/Write vanno bene.
	const char *hiscoreKey() override { return "dkongjr"; }
