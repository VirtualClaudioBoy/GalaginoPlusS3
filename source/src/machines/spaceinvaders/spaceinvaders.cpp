...
// High score: da MAME hiscore.dat, set "invaders" (voce base Midway, ampio
// gruppo di cloni/rebrand: invaders/invadersem/invadrmr/invasion*/searthin*/
// sicv*/sinvemag/sinvzen/sisv*/sitv*/spaceat2/spaceatt*/spacecom/spacerng/
// spceking/superinv/ultrainv).
const hiscore_region_S *spaceinvaders::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0x20f4, 0x02, 0x00, 0x00 },
  };
