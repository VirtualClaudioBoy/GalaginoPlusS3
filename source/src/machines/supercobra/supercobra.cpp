...
// High score: da MAME hiscore.dat, set "scobra" (voce condivisa dal gruppo
// scobra/scobrab/scobrae2/scobrag/scobraggi/scobras/scobrase).
const hiscore_region_S *supercobra::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0x8200, 0x1e, 0x00, 0x01 },
    { 0x80a8, 0x03, 0x00, 0x01 },
  };
