...
// High score: da MAME hiscore.dat, set "tutankhm" (voce condivisa dal gruppo
// tutankhm/tutankhms).
const hiscore_region_S *tutankhm::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0x88a9, 0x31, 0x03, 0x01 },
    { 0x88a6, 0x03, 0x03, 0x40 },
  };
