...
// High score: da MAME hiscore.dat, set "bombjack" (voce condivisa dal gruppo
// bombjack/bombjack2/bombjackt).
const hiscore_region_S *bombjack::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0x905f, 0x01, 0x30, 0x30 },
    { 0x907f, 0x01, 0x30, 0x30 },
    { 0x909f, 0x01, 0x30, 0x30 },
    { 0x90bf, 0x01, 0x30, 0x30 },
    { 0x90de, 0x03, 0x53, 0x24 },
    { 0x90fe, 0x03, 0x2d, 0x24 },
    { 0x911f, 0x01, 0x00, 0x00 },
    { 0x913f, 0x01, 0x00, 0x00 },
    { 0x80e2, 0x04, 0x00, 0x00 },
    { 0x8100, 0x96, 0x00, 0xff },
  };
