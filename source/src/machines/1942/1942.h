...
public:
	...
	// (main+audio) che a fine frame resta quasi sempre a 1 (interrupt sonoro
	// attivato ad ogni f-loop quando sub_cpu_reset e' falso) -> accesso
	// diretto alla RAM principale (0xe000-0xefff), bypassando il dispatch.
	const char *hiscoreKey() override { return "1942"; }
