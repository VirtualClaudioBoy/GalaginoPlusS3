...
// High score: da MAME hiscore.dat, set "1942" (voce condivisa dal gruppo
// 1942/1942a/1942abl/1942b/1942p/1942w).
const hiscore_region_S *_1942::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0xe800, 0x190, 0x00, 0x00 },
    { 0xe9c0, 0x001, 0x1e, 0x1e },
    { 0xe040, 0x008, 0x00, 0x00 },
    { 0xe028, 0x001, 0x01, 0x01 },
  };
