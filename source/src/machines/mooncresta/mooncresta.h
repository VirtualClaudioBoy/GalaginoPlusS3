...
public:
  ...
  // High score persistente (NVS). Work RAM 0x8000-0x83FF e' pura (default
  // hiscoreRead/Write = rdZ80/wrZ80 vanno bene), CPU singola.
  const char *hiscoreKey() override { return "mooncrst"; }
