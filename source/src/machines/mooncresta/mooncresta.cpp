...
// High score: da MAME hiscore.dat, set "mooncrst" (voce condivisa da un
// ampio gruppo di cloni: mooncrst/mooncrstu/mooncrstuk/mooncrstuku/
// mooncrstuu/mouncrst/sirio2/smooncrs/spcdrag/sstarcrs/starfgmc/stera).
const hiscore_region_S *mooncresta::hiscoreRegions(unsigned char *count) {
