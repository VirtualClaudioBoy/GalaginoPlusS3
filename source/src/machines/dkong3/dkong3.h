...
public:
    ...
    // High score persistente (NVS). general_ram (0x6000-0x6FFF) e' RAM pura,
    // default hiscoreRead/Write (rdZ80/wrZ80) vanno bene, CPU Z80 principale
    // singola (i due 6502 audio non intervengono su questo spazio indirizzi).
    const char *hiscoreKey() override { return "dkong3"; }
