...
public:
  ...
  // (main+audio), che a fine frame resta a 1 a meno che irq_enable[0] sia
  // attivo -> accesso diretto alla RAM principale (0x4000-0x47FF),
  // bypassando il dispatch.
  const char *hiscoreKey() override { return "scramble"; }
