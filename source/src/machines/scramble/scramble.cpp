...
// High score: da MAME hiscore.dat, set "scramble" (voce condivisa da un
// ampio gruppo di cloni: scramb2/scramb3/scramblb/scramble/scramblebb/
// scramblebf/scrambleo/scrambler/scrambles/scrambles2/scrambp/scramce/
// scrampt/scramrf/spcmission/spctrek/strfbomb/triplep/triplepa).
const hiscore_region_S *scramble::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0x4200, 0x1e, 0x00, 0x01 },
    { 0x40a8, 0x03, 0x00, 0x01 },
  };
