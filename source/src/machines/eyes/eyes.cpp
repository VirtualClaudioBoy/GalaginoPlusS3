...
// from MAME hiscore.dat (eyes)
const hiscore_region_S *eyes::hiscoreRegions(unsigned char *count) {
  static const hiscore_region_S regions[] = {
    { 0x4cf7, 0x3c, 0x4c, 0x00 },   // high score table
    { 0x43ed, 6,    0x00, 0x40 },   // video RAM: displayed high score
  };
  *count = 2;
  return regions;
}
