...
void Video::setViewport(uint16_t width) {
  ...
  // When leaving Scregg's full-width 240-pixel viewport, the centered
  // 224-pixel menu no longer overwrites columns 0..7 and 232..239. Clear
  // those two physical side bars once, before selecting the smaller window.
